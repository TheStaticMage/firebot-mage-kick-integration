...
- **Versions 0.11.0 and higher** require Firebot 5.65 or 5.66 and [firebot-mage-platform-lib](https://github.com/TheStaticMage/firebot-mage-platform-lib/) 0.0.5 or higher
- **Versions 0.10.1 and higher** require Firebot 5.65 and [firebot-mage-platform-lib](https://github.com/TheStaticMage/firebot-mage-platform-lib/) 0.0.2 or higher
...
1. From the latest [Release](https://github.com/TheStaticMage/firebot-mage-kick-integration/releases), download `firebot-mage-kick-integration-<version>.js` into your Firebot scripts directory (File &gt; Open Data Folder, then select the "scripts" directory).
...
Proceed to [Configuration Instructions](/doc/configuration.md) to configure the integration.
