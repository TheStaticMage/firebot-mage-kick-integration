import type { KickUser } from "../../../shared/types";
import { parseChatMessageEvent, parseChatMoveToSupportedChannelEvent, parseStreamHostedEvent, parseViewerBannedOrTimedOutEvent, parseViewerUnbannedEvent } from "../pusher-parsers";
        ...
        expect(result).toEqual({
            ...
            sender: {
                ...
                identity: {
                    ...
                    badges: [{ text: "Broadcaster", type: "broadcaster", count: undefined }]
                }
            },
            content: "Test 7",
