...
function verifyTestWebhookSignature(params: { rawPayload?: string; payload?: any; signature: string; testWebhookPublicKey: string }): void {
...
function verifyProductionWebhookSignature(params: { rawPayload?: string; payload?: any; signature: string; messageId?: string; timestamp?: string; productionWebhookPublicKey: string }): void {
