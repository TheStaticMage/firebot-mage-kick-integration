        ...
        expect(result).toEqual({
            ...
            sender: {
                ...
                identity: {
                    ...
                    badges: [{ text: "Broadcaster", type: "broadcaster", count: 0 }]
                }
            },
            content: "Test 7",
