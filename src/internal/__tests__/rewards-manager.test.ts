...
describe("RewardsManager", () => {
    ...
    describe("getAllRewards", () => {
        it("returns rewards on successful fetch", async () => {
            ...
            expect(mockKick.httpCallWithTimeout).toHaveBeenCalledWith("/public/v1/channels/rewards", "GET");
        ...
        it("returns cached rewards within one second", async () => {
            const mockRewards = [{ id: "kick-1", title: "Reward 1", cost: 100 }];
    ...
    describe("createReward", () => {
        it("creates reward with base values when no overrides", async () => {
            ...
            expect(mockKick.httpCallWithTimeout).toHaveBeenCalledWith("/public/v1/channels/rewards", "POST", expect.stringContaining('"title":"Test Reward"'));
    ...
    describe("updateReward", () => {
        it("updates reward with base values when no overrides", async () => {
            ...
            expect(mockKick.httpCallWithTimeout).toHaveBeenCalledWith("/public/v1/channels/rewards/kick-123", "PATCH", expect.stringContaining('"title":"Test Reward"'));
    ...
    describe("deleteReward", () => {
        it("deletes reward successfully", async () => {
            ...
            expect(mockKick.httpCallWithTimeout).toHaveBeenCalledWith("/public/v1/channels/rewards/kick-123", "DELETE");
            expect(result).toBe(true);
