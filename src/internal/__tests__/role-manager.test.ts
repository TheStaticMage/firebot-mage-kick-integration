        ...
        describe("built-in roles", () => {
            ...
            describe("moderator role", () => {
                it("returns true when user is a moderator by ID", async () => {
                    (firebot.modules.twitchApi.moderation.getModerators as jest.Mock).mockResolvedValue([{ userId: "123456789", userName: "testmod" }] as any);
                ...
                it("returns false when user is not a moderator", async () => {
                    (firebot.modules.twitchApi.moderation.getModerators as jest.Mock).mockResolvedValue([{ userId: "987654321", userName: "othermod" }] as any);
            ...
            describe("VIP role", () => {
                it("returns true when user is a VIP by ID", async () => {
                    (firebot.modules.twitchApi.channels.getVips as jest.Mock).mockResolvedValue([{ id: "123456789", name: "testvip" }] as any);
                ...
                it("returns false when user is not a VIP", async () => {
                    (firebot.modules.twitchApi.channels.getVips as jest.Mock).mockResolvedValue([{ id: "987654321", name: "othervip" }] as any);
            ...
            describe("subscriber role", () => {
                it("returns true when user is a subscriber by ID", async () => {
                    mockSubscriptionClient.getSubscriptionForUser.mockResolvedValue({
                        tier: "1000"
                    } as any);
    ...
    describe("userHasRole", () => {
        describe("platform detection", () => {
            ...
            it("defaults to twitch platform for regular usernames", async () => {
                (firebot.modules.twitchApi.moderation.getModerators as jest.Mock).mockResolvedValue([{ userId: "123456789", userName: "testuser" }] as any);
