import type { KickRewardManagementData } from "../../shared/types";
...
describe("KickRewardsState", () => {
    ...
    describe("saveManagementState", () => {
        it("saves state to file", () => {
            ...
            expect(mockFs.writeFileSync).toHaveBeenCalledWith("/data/kick-rewards-management.json", expect.stringContaining("reward-1"));
        });
