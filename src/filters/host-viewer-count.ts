import type { EventData, EventFilter } from "@crowbartools/firebot-custom-scripts-types/types/modules/event-filter-manager";
...
export const hostViewerCountFilter: EventFilter = {
    ...
    events: [
        { eventSourceId: IntegrationConstants.INTEGRATION_ID, eventId: "raid" },
        {
            ...
            eventId: "raid-sent-off"
        }
    ],
    comparisonTypes: [ComparisonType.IS, ComparisonType.IS_NOT, ComparisonType.LESS_THAN, ComparisonType.LESS_THAN_OR_EQUAL_TO, ComparisonType.GREATER_THAN, ComparisonType.GREATER_THAN_OR_EQUAL_TO],
    valueType: "number",
