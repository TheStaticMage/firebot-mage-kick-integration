...
export const kickChatMessageVariable: ReplaceVariable = {
    definition: {
        ...
        triggers: {
            manual: true,
            event: ["mage-kick-integration:chat-message", "mage-kick-integration:chat-message-deleted", "mage-kick-integration:viewer-arrived"]
        },
        categories: ["common"],
    ...
    evaluator: (trigger: Trigger) => {
        ...
        if (!chatMessage || chatMessage.trim() === "") {
            ...
            chatMessage = typeof trigger.metadata.eventData?.messageText === "string" ? trigger.metadata.eventData.messageText : "";
        }
